...
public class MenuGame extends JFrame {
    ...
    public MenuGame() {
        ...
        bgLabel = new JLabel(new ImageIcon("D:\\GitHub\\MakeAMove\\pics\\co_vua.jpg"));
        ...
        playButton.addActionListener((ActionEvent e) -> {
         ...
         if (selected != null) 
            ...
            if(check == 1){
                new GamePlay3(10, "Chơi với máy", 1001, "TTK").setVisible(true);     //chơi với máy thì bỏ time đi nhé (fix lại theo code u)
            }
            else if(check == 2){
        ...
        play2Button.addActionListener((ActionEvent e) -> {
            ...
            if(optionMode != null){
                ...
                if(check == 2){
                    new GamePlay2("Cờ úp").setVisible(true);
                }
                if(check == 1){
                    ...
                    if (selected != null) {
                        ...
                        if(minutes < 0){
                            new GamePlay(0, "1vs1", 1001, "TTK").setVisible(true);
                        }
                        else{
                            new GamePlay(minutes, "1vs1", 1001, "TTK").setVisible(true);
                            dispose(); 
                        }
